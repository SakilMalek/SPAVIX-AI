...
-- Plans table (must be first - referenced by other tables)
...
-- Subscriptions table (references plans and users)
CREATE TABLE IF NOT EXISTS subscriptions (
  ...
  CONSTRAINT valid_status CHECK (status IN ('active', 'trial', 'suspended', 'cancelled', 'expired')),
  UNIQUE(user_id)
);
...
-- Extend users table with subscription fields (after all tables created)
...
-- Create indexes for performance (after all tables and columns exist)
...
-- Create indexes on users table for subscription fields
